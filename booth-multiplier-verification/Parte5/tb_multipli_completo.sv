...
interface test_if (
	...
	logic empieza;
	logic termina;
	logic [tamano-1:0] data1_in;
	logic [tamano-1:0] data2_in;
	logic [2*tamano-1:0] data_out;
...
module prueba_multipli();
	...
	begin
		...
		$dumpvars(1, prueba_multipli.duv);
	end	
